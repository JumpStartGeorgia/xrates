...
<p>
პროგრამისტებო, თქვენთვის მონაცემები ხელმისაწვდომი გავხადეთ <a href="/ka/api" target="_blank">API</a>-ის საშუალებით და მივესალმებით მის გამოყენებას. გვსურს, თქვენგან გავიგოთ რისთვის და როგორ იყენებთ და შეგვიძლია თუ არა მისი კიდევ უფრო გაუმჯობესება.  
</p>
<p>
თუ გსურთ, მეტი გაიგოთ ლარის გზამკვლევისა და ჯამპსტარტის სხვა ხელსაწყოების შესახებ, <a href="http://jumpstart.ge/ka/contact-us" target="_blank">დაგვიკავშირდით !</a> 
</p>
<p>
