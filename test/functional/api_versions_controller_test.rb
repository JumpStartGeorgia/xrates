...
class ApiVersionsControllerTest < ActionController::TestCase
  ...
  test "should create api_version" do
    assert_difference('ApiVersion.count') do
      post :create, api_version: { permalink: @api_version.permalink, public: @api_version.public, public_at: @api_version.public_at, title: @api_version.title }
    end
  ...
  test "should update api_version" do
    put :update, id: @api_version, api_version: { permalink: @api_version.permalink, public: @api_version.public, public_at: @api_version.public_at, title: @api_version.title }
    assert_redirected_to api_version_path(assigns(:api_version))
  end
